...
adservice.saveAdvertisement = function (advert) {
    return new Promise(function (resolve, reject) {
        if (_isAdvertValid(advert)) {
            advertisement.insert(new _advertisement2.default(advert.name, advert.format, advert.impressions, advert.startDate, advert.endDate, advert.advertHtml)).then(function (status) {
...
var _isFormatValid = function _isFormatValid(formatToValidate) {
    var set = new Set(['Top Banner', 'Interstitial', 'Site Skin', 'Bottom Banner', 'Hover']);
